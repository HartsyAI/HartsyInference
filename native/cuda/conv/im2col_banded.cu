...
//     native/cuda/conv/im2col_banded.cu native/cuda/conv/im2col_banded.ptx compute_80 ~/.local/lib/cuda13/include
//   cp native/cuda/conv/im2col_banded.ptx src/HartsyInference.Cuda/Ptx/
