...
/// <summary>The resident-prefix sizing arithmetic, isolated so it can be swept on CPU against the hand-rolled
/// formula it replaces.</summary>
public static class ResidentPrefixSizing
{
    ...
    /// <param name="freeBytes">Free device memory, read AFTER a pool trim — untrimmed slack counts as used and
    /// under-sizes the prefix.</param>
