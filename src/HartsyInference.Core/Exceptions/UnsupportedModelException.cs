...
/// <summary>Thrown when a model file's architecture or format is not supported by HartsyInference.</summary>
public sealed class UnsupportedModelException : HartsyInferenceException
{
