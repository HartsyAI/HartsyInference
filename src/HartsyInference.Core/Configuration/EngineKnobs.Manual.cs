...
public static partial class EngineKnobs
{
    ...
    public static readonly Knob<bool?> Ltx2Ancestral =
        BoolOverride("numerics.ltx2Ancestral", KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int?> Ltx2ShiftMaxTokens =
        IntOverride("numerics.ltx2ShiftMaxTokens", KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<float?> Ltx2Shift =
        FloatOverride("numerics.ltx2Shift", KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int?> H3ChunkRows =
        IntOverride("vram.h3ChunkRows", KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<int?> Hy3dVaeChunk =
        IntOverride("vram.hy3dVaeChunk", KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<int?> HeartcodecScalarChunk =
        IntOverride("vram.heartcodecScalarChunk", KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<int?> HiftStreamMargin =
        IntOverride("numerics.hiftStreamMargin", KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int?> SdpaTile =
        IntOverride("numerics.sdpaTile", KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int?> Int8NChunk =
        IntOverride("vram.int8NChunk", KnobScope.Runtime, KnobDomain.Vram,
    ...
    /// <remarks>Shares <c>numerics.ditGraph</c> with <see cref="DitGraph"/> on purpose, so <c>=0</c> kills both tiers
    ...
    public static readonly Knob<bool> DitGraphDefaultOn =
        Bool("numerics.ditGraphDefaultOn", true, KnobScope.Runtime, KnobDomain.Numerics,
            "Default-ON tier of DiT step-graph capture, for architectures where the per-generation graph is a validated win.");

    // ── Knobs named after their model rather than the engine, so the first inventory missed them ──
    ...
    public static readonly Knob<int> WanSolverOrder =
        Int("numerics.wanSolverOrder", 2, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> WanS2vTrim =
        Bool("vram.wanS2vTrim", true, KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<string?> LtxDiagFile =
        Str("diagnostics.ltxDiagFile", null, KnobScope.Runtime, KnobDomain.Diagnostics,
    ...
    public static readonly Knob<bool> LtxDiag =
        Bool("diagnostics.ltxDiag", false, KnobScope.Runtime, KnobDomain.Diagnostics,
            "Enables LTX-Video per-step diagnostics on the console.");

    /// <summary>The explicit opt-in sense of <c>numerics.sageAttn</c>: true only when it is set to exactly <c>1</c>.</summary>
    ...
    public static readonly Knob<bool> SageAttnExplicit =
        Bool("numerics.sageAttnExplicit", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int> CpuThreads =
        Int("numerics.cpuThreads", 0, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<long> AudioEvictBelowGb =
        Long("vram.audioEvictBelowGb", 14L, KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<long> Im2colBandMb =
        Long("vram.im2colBandMb", 1024L, KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<long> Int8RowBudgetMb =
        Long("vram.int8RowBudgetMb", 0L, KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<int> GemvKsplit =
        Int("numerics.gemvKsplit", -1, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int> GemvWpb =
        Int("numerics.gemvWpb", 4, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<long> GraphArenaMb =
        Long("vram.graphArenaMb", 32L, KnobScope.Runtime, KnobDomain.Vram,
    ...
    public static readonly Knob<int> SageF16MinSkv =
        Int("numerics.sageF16MinSkv", 8192, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<int> H2dTraceLimit =
        Int("diagnostics.h2dTraceLimit", 24, KnobScope.Runtime, KnobDomain.Diagnostics,
    ...
    public static readonly Knob<string?> LogLevel =
        Str("diagnostics.logLevel", null, KnobScope.Runtime, KnobDomain.Diagnostics,
