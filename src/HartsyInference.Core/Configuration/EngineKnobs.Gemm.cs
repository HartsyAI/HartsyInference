...
/// <remarks>Declared as a group because they were all reached the same way before the migration: the CUDA
/// backend's <c>EnvFlag</c> helper, which meant a literal <c>1</c> and nothing else. Every one defaults to
/// <c>false</c>.
...
public static partial class EngineKnobs
{
    ...
    public static readonly Knob<bool> SdpaV2 =
        Bool("numerics.sdpaV2", "HARTSY_SDPA_V2", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> SdpaForceFlash =
        Bool("numerics.sdpaForceFlash", "HARTSY_SDPA_FORCE_FLASH", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> SdpaF16 =
        Bool("numerics.sdpaF16", "HARTSY_SDPA_F16", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> SdpaNoF16 =
        Bool("numerics.sdpaNoF16", "HARTSY_SDPA_NO_F16", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> FlashSplitForce =
        Bool("numerics.flashSplitForce", "HARTSY_FLASH_SPLIT_FORCE", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> FlashSplitOff =
        Bool("numerics.flashSplitOff", "HARTSY_FLASH_SPLIT_OFF", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> SageUnsafeF32VNarrow =
        Bool("numerics.sageUnsafeF32VNarrow", "HARTSY_SAGE_UNSAFE_F32_V_NARROW", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> TensorcoreGemm =
        Bool("numerics.tensorcoreGemm", "HARTSY_TENSORCORE_GEMM", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> HighPrecisionGemm =
        Bool("numerics.highPrecisionGemm", "HARTSY_HIGH_PRECISION_GEMM", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> Fp8F16 =
        Bool("numerics.fp8F16", "HARTSY_FP8_F16", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> Fp8F32 =
        Bool("numerics.fp8F32", "HARTSY_FP8_F32", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> NoTf32 =
        Bool("numerics.noTf32", "HARTSY_NO_TF32", false, KnobScope.Runtime, KnobDomain.Numerics,
    ...
    public static readonly Knob<bool> GemmF16 =
        Bool("numerics.gemmF16", "HARTSY_GEMM_F16", false, KnobScope.Runtime, KnobDomain.Numerics,
