...
public sealed unsafe class HunyuanImageTransformer : IDisposable, IStreamableDenoiser
{
    ...
    // HunyuanImage does NOT opt into the shared 16-bit hot path (unlike the other DiTs on numerics.ditF16 — see
