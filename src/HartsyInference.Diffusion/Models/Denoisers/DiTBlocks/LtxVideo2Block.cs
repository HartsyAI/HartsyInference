...
public sealed unsafe class LtxVideo2Block : IStreamingBlock
{
    ...
    public void LoadWeights(IReadOnlyDictionary<string, Tensor> w, string p)
    {
        ...
        _ssVideo = TensorCasts.LoadF32(w, $"{p}.scale_shift_table");
        _ssAudio = TensorCasts.LoadF32(w, $"{p}.audio_scale_shift_table");
        ...
        _promptVideo = w.ContainsKey($"{p}.prompt_scale_shift_table") ? TensorCasts.LoadF32(w, $"{p}.prompt_scale_shift_table") : null;
        _promptAudio = w.ContainsKey($"{p}.audio_prompt_scale_shift_table") ? TensorCasts.LoadF32(w, $"{p}.audio_prompt_scale_shift_table") : null;
        _caVideo = TensorCasts.LoadF32(w, $"{p}.scale_shift_table_a2v_ca_video");
        _caAudio = TensorCasts.LoadF32(w, $"{p}.scale_shift_table_a2v_ca_audio");
