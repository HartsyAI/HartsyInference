...
/// every test in <c>HartsyInference.Diffusion.Tests</c> demonstrates it. The boilerplate that this
...
public static class PipelineFactory
{
    ...
    public static DiffusionPipelineBase LoadAuto(string path, IBackend backend)
    {
        ...
        throw new NotImplementedException(
            ...
            "clipL, clipG, unet, vaeDecoder, ...)) — every test in HartsyInference.Diffusion.Tests " +
