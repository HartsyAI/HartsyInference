...
///
/// <para><b>Status: built, first-run validation pending</b> — like the image pipeline, the numerics are checkpoint-gated. T2V uses 2-way text CFG (3-way vision CFG / video editing needs the ViT — deferred). Frame streaming + encoding are layered on in <c>HartsyInference.Video/Streaming</c> + <c>/Encoding</c>.</para></summary>
