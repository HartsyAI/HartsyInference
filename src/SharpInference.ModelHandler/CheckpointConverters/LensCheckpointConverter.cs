...
using SharpInference.ModelHandler.Mxfp4;
using SharpInference.ModelHandler.Mxfp8;
using SharpInference.ModelHandler.Nvfp4;
...
public sealed class LensCheckpointConverter
{
    ...
    {
        /// <summary>Diffusers-format transformer weights consumed by <see cref="SharpInference.Diffusion.Models.Denoisers.LensTransformer.LoadWeights"/>.</summary>
