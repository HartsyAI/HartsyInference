...
/// <summary>Loads + buckets an Anima (Cosmos-Predict2 family) safetensors checkpoint into transformer /
/// VAE / text encoder dictionaries. Anima ships in canonical diffusers naming, so no key remapping is
/// required.</summary>
