...
/// <summary>Converts single-file SDXL checkpoints (LDM/CompVis format) to diffusers-format weight dictionaries that can be loaded by SharpInference model components.</summary>
