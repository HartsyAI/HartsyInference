...
namespace SharpInference.ModelHandler.Registry;

/// <summary>Disk-based model cache at ~/.sharpinference/models/. Tracks downloaded models and their local file paths for fast re-loading without re-downloading.</summary>
public sealed class ModelCacheStore
{
    ...
    /// <summary>Creates a model cache store at the default location (~/.sharpinference/models/).</summary>
