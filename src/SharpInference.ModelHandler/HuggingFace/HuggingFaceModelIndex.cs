...
using SharpInference.ModelHandler.Registry;

namespace SharpInference.ModelHandler.HuggingFace;
...
public sealed class HuggingFaceModelIndex
{
        ...
        CancellationToken ct)
    {
        ...
        string tempDir = Path.Combine(Path.GetTempPath(), "sharpinference", "config_cache");
