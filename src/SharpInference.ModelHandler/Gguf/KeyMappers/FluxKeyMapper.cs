...
/// <summary>Maps Flux GGUF tensor names → BFL single-file naming that <see cref="SharpInference.ModelHandler.CheckpointConverters.FluxCheckpointConverter.Convert"/> expects.
///
