...
/// <summary>Chroma GGUF mapper. Chroma ships in BFL single-file naming with the additional <c>distilled_guidance_layer.*</c> tree. <see cref="SharpInference.ModelHandler.CheckpointConverters.ChromaCheckpointConverter.Convert"/> already handles those keys.</summary>
