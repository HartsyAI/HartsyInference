...
/// <summary>SD 1.5 GGUF mapper. SD15 GGUFs use the LDM naming (<c>model.diffusion_model.input_blocks.X.Y.weight</c> etc.) that <see cref="SharpInference.ModelHandler.CheckpointConverters.Sd15CheckpointConverter.Convert"/> already handles.</summary>
