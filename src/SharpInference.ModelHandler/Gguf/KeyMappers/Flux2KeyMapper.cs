...
/// <summary>Flux.2 (Klein 4B / Klein 9B / Dev) GGUF mapper. Flux.2 ships with BFL-style naming carrying <c>double_stream_modulation_*</c> top-level shared modulation linears + <c>double_blocks.*</c> + <c>single_blocks.*</c>. <see cref="SharpInference.ModelHandler.CheckpointConverters.Flux2CheckpointConverter.Convert"/> handles the BFL→canonical remap; we just pass through.</summary>
