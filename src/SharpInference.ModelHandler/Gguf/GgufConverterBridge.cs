...
/// </code>
///
/// <para>Same pattern for SDXL (<see cref="SharpInference.ModelHandler.CheckpointConverters.SdxlCheckpointConverter.Convert"/>), SD3 (<see cref="SharpInference.ModelHandler.CheckpointConverters.Sd3CheckpointConverter.Convert"/>), and every other model. **No per-pipeline shim is required** — the bridge is generic over the converter delegate.</para></summary>
