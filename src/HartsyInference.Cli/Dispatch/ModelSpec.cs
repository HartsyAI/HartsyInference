...
public sealed record ModelSpec
{
    ...
    /// <summary>Auxiliary load-time paths for multi-file models (e.g. "text-encoder-path", "vae-path",
    /// "tokenizer-path"), keyed by role. Empty for single-file models.</summary>
