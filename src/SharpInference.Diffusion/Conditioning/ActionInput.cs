...
/// <summary>One frame's worth of raw action state from the application. <see cref="Payload"/> is a model-defined byte
/// layout (key states, mouse deltas, camera pose, …) interpreted by the model's <see cref="IActionEncoder"/>; the
/// engine never parses it. See <c>docs/Research/INTERACTIVE_INFERENCE.md</c> § 2.</summary>
