...
public sealed class LensGptOssEncoder : IDisposable
{
    ...
    /// <see cref="SharpInference.ModelHandler.Mxfp4.Mxfp4Codec.DequantGptOssExpertsInPlace"/>, so the
    ...
    /// multi-layer hidden-state captures expected by <see cref="SharpInference.Diffusion.Pipelines.LensPipeline"/>.
    ...
    /// <param name="tokenIds">Chat-templated token ids (rendered by <see cref="SharpInference.Tokenizers.GptOssTokenizer.BuildChatInputs"/>).</param>
