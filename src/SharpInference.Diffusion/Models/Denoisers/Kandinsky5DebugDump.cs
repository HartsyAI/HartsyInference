...
/// <summary>Optional layer-by-layer debug dump for Kandinsky 5. When the environment variable
/// <c>KANDINSKY5_DEBUG_DIR</c> is set, the transformer writes each named tensor as raw F32 to that
/// directory under <c>layers/&lt;safe_name&gt;.bin</c>. Disabled (zero-cost) otherwise. Used to diff
...
internal static unsafe class Kandinsky5DebugDump
{
    ...
    {
        string? dir = Environment.GetEnvironmentVariable("KANDINSKY5_DEBUG_DIR");
