...
internal static unsafe class LanceDebugDump
{
    ...
    {
        string? dir = Environment.GetEnvironmentVariable("LANCE_DEBUG_DIR");
    ...
    private static void WriteRawF32(string path, Tensor t)
    {
        ...
        fixed (byte* dst = buffer)
            Buffer.MemoryCopy((float*)f32.DataPointer, dst, buffer.Length, buffer.Length);
