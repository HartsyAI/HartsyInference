...
internal static unsafe class Ideogram4DebugDump
{
    ...
    {
        string? dir = Environment.GetEnvironmentVariable("IDEOGRAM4_DEBUG_DIR");
    ...
    public static void Dump(string name, Tensor t)
    {
        ...
        WriteRawF32(Path.Combine(s_dumpDir, "layers", safe + ".bin"), t);
    }
