...
/// classes. All ops produce <c>F32</c> output to match the rest of SharpInference's VAE path.</para></summary>
public static unsafe class QwenImageVaeOps
{
    ...
    public static Tensor SliceConv3dToConv2d(Tensor conv3dWeight, int temporalSlot = -1)
    {
        ...
        // ops; SharpInference's mixed-precision conv is reserved for the bigger diffusion convs).
