...
namespace SharpInference.Audio.Models.Codecs;
...
public static unsafe class Fsq
{
    ...
    public static void Quantize(Tensor codes, Tensor z, ReadOnlySpan<int> levels)
    {
        ...
        // Precompute per-axis halfL and shift values for tanh-bound math.
        ...
        // Precompute base-L place values for packing.
