...
/// <summary>AuraFlow GGUF mapper. <c>city96/AuraFlow-v0.3-gguf</c> ships with BFL-style naming with <c>double_layers.*</c> and <c>single_layers.*</c> prefixes — <see cref="HartsyInference.ModelHandler.CheckpointConverters.AuraFlowCheckpointConverter.Convert"/> handles the BFL→diffusers remap.</summary>
