...
/// <param name="Repo">Repo to pull this file from, when it is not the model's own — Kyutai's SentencePiece model is not shipped in the checkpoint repo. Null means the model's repo.</param>
public readonly record struct AudioModelFile(string Name, bool Required = true, string? Sha256 = null, string? Repo = null);
