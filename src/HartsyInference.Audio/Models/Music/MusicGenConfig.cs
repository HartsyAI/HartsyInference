...
/// <summary>Configuration for MusicGen / AudioGen (Meta AudioCraft), an autoregressive Transformer that generates EnCodec tokens conditioned on T5-base text via cross-attention. See <c>docs/Research/MUSICGEN_ARCHITECTURE.md</c>.</summary>
/// <remarks>K residual codebooks are
...
/// and carries no T5 dependency in the Audio package.</para></remarks>
public sealed record MusicGenConfig
{
    ...
    /// <summary>Delay offsets per codebook. Mono default <c>[0,1,2,3]</c>; stereo doubles to <c>[0,0,1,1,2,2,3,3]</c>.</summary>
