...
/// F16 in/out.</para>
///
/// <para><b>Alignment.</b> The kernel omits per-element bounds checks for speed, so it only handles
/// <c>M%16==0, N%8==0, K%16==0</c>. Use <see cref="IsAligned"/> to decide; unaligned shapes must fall back
/// to cuBLAS.</para>
///
/// <para><b>Validation-pending.</b> The PTX fragment layout has not been verified on GPU. Gate any production
/// use behind a benchmark + a numerical diff against cuBLAS (see <c>TensorCoreGemmTests</c>); the engine keeps
/// this off by default (<see cref="CudaBackend.EnableTensorCoreGemm"/>).</para>
/// </remarks>
