...
//     src/HartsyInference.Cuda/Kernels/vision/msda.cu src/HartsyInference.Cuda/Kernels/vision/msda.ptx compute_80 ~/.local/lib/cuda13/include
//   cp src/HartsyInference.Cuda/Kernels/vision/msda.ptx src/HartsyInference.Cuda/Ptx/
