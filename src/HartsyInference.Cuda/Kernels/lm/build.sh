...
# HartsyInference.Cuda Ptx folder. Uses nvcc (CUDA 11+) when it is on PATH, else the committed ../nvrtc_compile frontend,
# which needs the CUDA headers ($CUDA_INC). Target SM 8.0 (Ampere+);
