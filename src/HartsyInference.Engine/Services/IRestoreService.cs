...
/// <summary>Video/image restoration (SeedVR2): degraded media in, restored frames out at the
/// area-normalized target size. Frame-streaming shape matches <see cref="IVideoService"/> so the CLI/SSE
/// frame plumbing is shared.</summary>
