...
/// <summary>Typed image-generation surface: detect the model's architecture, apply the request's composition
/// (LoRA/ControlNet/IP-Adapter/Refiner/img2img/inpaint/regional), and generate.</summary>
