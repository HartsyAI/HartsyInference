...
/// <summary>MeloTTS English-v3 (VITS + multi-stream text encoder) at 44.1 kHz. Self-contained: the engine facade bundles the CMUdict g2p (phoneme + tone + language streams) and the bert-base-uncased prosody front-end, so no external phonemizer wiring is needed. Not zero-shot — no voice reference required.</summary>
