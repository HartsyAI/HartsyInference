...
/// <summary>One timestamped span of a transcript. Granularity is whatever the model natively emits — for Whisper that is a phrase/utterance chunk delimited by <c>&lt;|t|&gt;</c> tokens, never a single word.</summary>
