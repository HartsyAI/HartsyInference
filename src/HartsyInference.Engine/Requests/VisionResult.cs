...
/// <summary>The result of a vision request. Which field is populated depends on the request mode: an embedding for
/// Embed, detections for Detect, masks for Segment.</summary>
