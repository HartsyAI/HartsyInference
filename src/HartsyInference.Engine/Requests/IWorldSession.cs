...
/// <summary>A stateful interactive-world session: send actions and pull the frames the world produces in response. The session owns its model/device state until disposed.</summary>
