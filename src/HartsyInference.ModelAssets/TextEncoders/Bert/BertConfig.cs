...
/// <summary>Configuration for a standard HuggingFace BERT encoder. Defaults match <c>chinese-roberta-wwm-ext-large</c> (the GPT-SoVITS text-conditioning BERT): 24 post-norm layers, hidden 1024, 16 heads, intermediate 4096, vocab 21128, learned absolute positions, exact GELU, LayerNorm eps 1e-12.</summary>
public sealed record BertConfig
{
    ...
    /// <summary>bert-base-uncased preset (MeloTTS English prosody BERT): 12 layers, hidden 768, 12 heads, intermediate 3072, vocab 30522.</summary>
    public static BertConfig BaseUncased => new()
    {
        Hidden = 768, NumLayers = 12, NumHeads = 12, Intermediate = 3072, VocabSize = 30522,
    };

    /// <summary>cl-tohoku/bert-base-japanese-v3 preset (MeloTTS Japanese prosody BERT): 12 layers, hidden 768, 12 heads, intermediate 3072, vocab 32768.</summary>
    public static BertConfig JapaneseV3 => new()
    {
        Hidden = 768, NumLayers = 12, NumHeads = 12, Intermediate = 3072, VocabSize = 32768,
    };

    /// <summary>hfl/chinese-roberta-wwm-ext preset (base size): 12 layers, hidden 768, 12 heads, intermediate 3072, vocab 21128.</summary>
    ...
    /// <summary>Grounding DINO text tower (<c>bert-base-uncased</c> topology): 12 layers, hidden 768, 12 heads, intermediate 3072, vocab 30522.</summary>
