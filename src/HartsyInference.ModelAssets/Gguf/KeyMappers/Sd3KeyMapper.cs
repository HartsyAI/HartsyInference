...
/// <summary>SD3 / SD3.5 GGUF mapper. SD3 GGUFs use the Stability single-file naming with <c>model.diffusion_model.</c> prefix that <see cref="HartsyInference.ModelAssets.CheckpointConverters.Sd3CheckpointConverter.Convert"/> already handles.</summary>
