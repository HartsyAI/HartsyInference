...
/// <summary>Chroma GGUF mapper. Chroma ships in BFL single-file naming with the additional <c>distilled_guidance_layer.*</c> tree. <see cref="HartsyInference.ModelAssets.CheckpointConverters.ChromaCheckpointConverter.Convert"/> already handles those keys.</summary>
