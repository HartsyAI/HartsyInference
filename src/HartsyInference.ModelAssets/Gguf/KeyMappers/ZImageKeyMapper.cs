...
/// <summary>Z-Image (Lumina2/NextDiT) GGUF mapper. Tongyi-Lab dumps ship with the single-file naming with <c>model.diffusion_model.</c> wrapper or the <c>transformer.</c> wrapper that <see cref="HartsyInference.ModelAssets.CheckpointConverters.ZImageCheckpointConverter.Convert"/> already strips.</summary>
