...
/// <summary>Maps Flux GGUF tensor names → BFL single-file naming that <see cref="HartsyInference.ModelAssets.CheckpointConverters.FluxCheckpointConverter.Convert"/> expects.
///
