...
public sealed unsafe class Codec_IQ4_NL : GgufCodecBase
{
    ...
    /// <summary>Canonical ggml `kvalues_iq4nl` codepoint table — 16 signed integer values that act as the dequantization lookup. Verbatim from `ggml-quants.c`; IQ4_XS indexes the same table.</summary>
    internal static readonly sbyte[] KValues = new sbyte[]
    {
