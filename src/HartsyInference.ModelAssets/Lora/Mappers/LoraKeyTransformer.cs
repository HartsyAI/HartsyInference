...
public static class LoraKeyTransformer
{
    ...
    [
        ...
        ("input_blocks", "\x01IBLOCKS\x01"),
        ("output_blocks", "\x01OBLOCKS\x01"),
        ("middle_block", "\x01MIDDLEBLOCK\x01"),
        ("in_layers", "\x01INLAYERS\x01"),
        ("out_layers", "\x01OUTLAYERS\x01"),
        ("emb_layers", "\x01EMBLAYERS\x01"),
        ("skip_connection", "\x01SKIPCONN\x01"),
