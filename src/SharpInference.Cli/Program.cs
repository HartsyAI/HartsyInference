...
public static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        Console.WriteLine("SharpInference CLI - SD1.5 image generation");
    ...
    private static string ResolveRepoRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(current, "SharpInference.sln")))
                return current;
    ...
    {
        Console.WriteLine("Usage: SharpInference.Cli [options]");
        Console.WriteLine();
