namespace HartsyInference.Video.Tests.Helpers;

// Copied verbatim from tests/HartsyInference.Diffusion.Tests/Helpers/Ssim.cs (single source of truth for the
// algorithm constants); duplicated because test projects do not reference each other.
