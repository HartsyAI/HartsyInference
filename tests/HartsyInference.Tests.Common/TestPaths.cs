...
public static class TestPaths
{
    ...
    public static class IpAdapter
    {
        ...
        /// <summary>FaceID-Plus / Plus-v2 checkpoints (h94/IP-Adapter-FaceID .bin: ProjPlusModel = FaceID MLP + CLIP-Vision perceiver) + companion kohya UNet LoRAs.</summary>
        public static string Sd15FaceIdPlus       => Resolve("IPA_SD15_FACEID_PLUS_PATH",        Path.Combine(ModelsDir, "ipadapter", "ip-adapter-faceid-plus_sd15.bin"));
        public static string Sd15FaceIdPlusV2     => Resolve("IPA_SD15_FACEID_PLUSV2_PATH",      Path.Combine(ModelsDir, "ipadapter", "ip-adapter-faceid-plusv2_sd15.bin"));
        public static string Sd15FaceIdPlusV2Lora => Resolve("IPA_SD15_FACEID_PLUSV2_LORA_PATH", Path.Combine(ModelsDir, "ipadapter", "ip-adapter-faceid-plusv2_sd15_lora.safetensors"));
        public static string SdxlFaceIdPlusV2     => Resolve("IPA_SDXL_FACEID_PLUSV2_PATH",      Path.Combine(ModelsDir, "ipadapter", "ip-adapter-faceid-plusv2_sdxl.bin"));
        public static string SdxlFaceIdPlusV2Lora => Resolve("IPA_SDXL_FACEID_PLUSV2_LORA_PATH", Path.Combine(ModelsDir, "ipadapter", "ip-adapter-faceid-plusv2_sdxl_lora.safetensors"));

        /// <summary>Directory of ProjPlusModel golden refs generated by <c>tests/python-reference/ipadapter_faceid_plus_ref.py</c> (one <c>&lt;checkpoint&gt;_projref.safetensors</c> per FaceID-Plus checkpoint).</summary>
        public static string FaceIdPlusRefDir => Resolve("FACEID_PLUS_REF_DIR", Path.Combine(OutputDir, "References", "faceid-plus"));
