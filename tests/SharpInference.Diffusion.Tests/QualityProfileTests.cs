...
using SharpInference.Diffusion.Quality;
using Xunit;
...
public sealed class QualityProfileTests
{
    ...
    public void Validate_RejectsFp8Vae()
    {
        ...
        Assert.Throws<SharpInferenceException>(() => p.Validate());
    }
    ...
    {
        SharpInference.ModelHandler.CheckpointConverters.FluxCheckpointConverter.ConvertedWeights converted = new()
        {
    ...
    {
        SharpInference.ModelHandler.CheckpointConverters.SdxlCheckpointConverter.ConvertedWeights converted = new()
        {
    ...
    public void FluxQualityLoader_RejectsInvalidVaeDtype()
    {
        ...
        Assert.Throws<SharpInferenceException>(() => FluxQualityLoader.Apply(converted, bad));
    }
