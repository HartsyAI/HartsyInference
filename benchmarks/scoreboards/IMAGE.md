...
`docs/PERFORMANCE.md` §5, `docs/Checklists/MODEL_STATUS_IMAGE.md`) plus a set of narrower one-off result
files — those files are not deleted and remain the primary evidence for the numbers below; this file only
consolidates the headline figures. Full methodology (hardware baseline, the standard performance profile
...
|---|---|---:|---:|---:|---|---|
| Flux-Schnell (4 st) | 4090 | **2.4 s** | 3.8 s | **0.63×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Flux.2 Klein 4B (4 st) | 4090 | **2.36 s** | 1.85 s | 1.28× | 2026-07-11 | [PERFORMANCE.md §5](../../docs/PERFORMANCE.md) |
| Krea2-Turbo (8 st) | 4090 | **4.5 s** | 6.5 s | **0.69×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Z-Image-Turbo (8 st) | 4090 | 4.2 s | **3.1 s** | 1.35× | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md)¹ |
...
| Lance-3B (30 st) | 4090 | 9.6 s | unsupported (no ComfyUI arch) | — | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Chroma1-Radiance (fp8, 20 st) | 4090 | **21.46 s** | 21.07 s (fp8) | 1.02× | 2026-07-18 | [python baselines](../results/image_python_baselines_2026-07-18.md) |
| Krea2-Base (28 st) | 4090 | **30.3 s** | 41.5 s | **0.73×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Flux2-Dev 32B (Q4_K_S GGUF, 20 st) | 4090 | **39.6 s** | 54.0 s | **0.73×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Qwen-Image (20 st) | 4090 | **40.6 s** | 58.2 s | **0.70×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| HiDream-i1 17B (25 st, cfg 5) | 4090 | 44.0 s | **35.2 s** | 1.25× | 2026-07-11 | [PERFORMANCE.md §5](../../docs/PERFORMANCE.md) |
| Chroma1-HD (30 st, cfg 7)² | 4090 | **24.6 s** | 32.6 s | **0.75×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Boogu-Base (20 st) | 4090 | 26.5 s | **17.8 s** | 1.49× | 2026-07-11 | [PERFORMANCE.md §5](../../docs/PERFORMANCE.md) |
| Ideogram4 (20 st) | 4090 | 19.5 s | **18.0 s** | 1.08× | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| OmniGen2 (20 st) | 4090 | 15.1 s | **13.0 s** | 1.16× | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Flux-Dev (20 st) | 4090 | **9.5 s** | 12.5 s | **0.76×** | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| SDXL (20 st)³ | 4090 | 10.9 s | **7.5 s** | 1.45× | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| HunyuanImage 2.1 17B (Q4_K_M GGUF, 2048², 20 st) | 4090 | 48.3 s | **47.1 s** | 1.03× (matched) | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Qwen-Image-Edit 2511 (20 st + ref, edit) | 4090 | 93 s | **87.8 s** | 1.06× | 2026-07-11 | [PERFORMANCE.md §5](../../docs/PERFORMANCE.md) |
| Lumina-Image 2.0 (25 st, cfg 4)⁴ | 4090 | 17.7 s | **10.05 s** | 1.76× | 2026-07-18 | [python baselines](../results/image_python_baselines_2026-07-18.md) |
| F-Lite 10B (30 st, cfg 6)⁵ | 4090 | **61.5 s** | 122.98 s (Python/diffusers) | **0.50×** | 2026-07-18 | [python baselines](../results/image_python_baselines_2026-07-18.md) |
| Anima (Cosmos-Predict2 2B, 20 st)⁶ | 4090 | 160.0 s | **2.4 s** | 66.7× | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Anima (Cosmos-Predict2 2B, 20 st)⁶ | 3060 | 168.1 s | **8.3 s** | 20.3× | 2026-07-26 | [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Ideogram4 (20 st, low-VRAM stream)⁷ | 3060 | 205.2 s (Debug build) | 156.0 s (Release) | — (not same build) | 2026-07-27 | [lowvram fix §5f](../results/2026-07-27_lowvram_leak_fix.md) / [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
| Qwen-Image (20 st, low-VRAM stream)⁷ | 3060 | 231.4 s (Debug build) | 242.9 s (Release) | — (not same build) | 2026-07-27 | [lowvram fix §5g](../results/2026-07-27_lowvram_leak_fix.md) / [2026-07-26 sweep](../results/2026-07-26_image_comfy-vs-hartsy.md) |
...
- **Z-Image-Turbo regression flag.** The 2026-07-26 sweep's headline Hartsy number (4.2 s) is used above
  ...
  **2.74 s** through the production SwarmUI path against a documented flagship regression bar of **≤3.2 s**
  ([`2026-07-23_swarm_stepcache_verification.md`](../results/2026-07-23_swarm_stepcache_verification.md)).
...
- **SDXL.** The 2026-07-26 sweep downloaded SDXL fresh (`stabilityai/stable-diffusion-xl-base-1.0`,
  ...
  engine-side regression. [`2026-07-27_lowvram_leak_fix.md`](../results/2026-07-27_lowvram_leak_fix.md) §3
...
- **Lumina-Image 2.0 — correctness caveat, not just perf.** The 17.7 s / 10.05 s pair above is the last
  clean timing measurement, but [`2026-07-27_lowvram_leak_fix.md`](../results/2026-07-27_lowvram_leak_fix.md)
...
- **Anima — perf numbers are stale as of the 07-26 sweep.** The 160.0 s/168.1 s figures above reflect the
  pre-fix engine. [`2026-07-27_lowvram_leak_fix.md`](../results/2026-07-27_lowvram_leak_fix.md) §5c ported
...
- **Lens (Turbo / RL-tuned) excluded from the table.** Both variants produced solid-black output via the
  ...
  [`2026-07-27_lowvram_leak_fix.md`](../results/2026-07-27_lowvram_leak_fix.md) §5d. Output is verified
...
- **RTX 3060 capacity, general.** As of 2026-07-26, only Anima ran on the Hartsy@3060 lane; every other
  model returned `OOM²`. [`2026-07-27_lowvram_leak_fix.md`](../results/2026-07-27_lowvram_leak_fix.md)
...
- **Step-cache (`HARTSY_STEP_CACHE=1`) — default OFF, queued/opt-in.** Per-model calibrated First-Block-Cache,
  ...
  no-op). See [`2026-07-23_swarm_stepcache_verification.md`](../results/2026-07-23_swarm_stepcache_verification.md)
...
- **Limited-interval CFG (`HARTSY_CFG_INTERVAL`) — default OFF, negative result for Qwen-Image.** The
  ...
  [`2026-07-22_accel_cfginterval_qwen_4090.md`](../results/2026-07-22_accel_cfginterval_qwen_4090.md).
