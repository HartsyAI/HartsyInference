...
|---|---|---|---:|---|---:|---|---|---|
| Piper (VITS) | TTS | 3060 / 4090 | **8.6× / 8.3×** | self-comparison | — | 2026-07-12 | Swarm | [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md) |
| Kokoro-82M (StyleTTS2) | TTS | 3060 / 4090 | **4.5× / 5.2×** | self-comparison | — | 2026-07-12 | Swarm | [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md) |
| StyleTTS2 (LibriTTS) | TTS (clone) | 4090 | **~1.3×** | self-comparison | — | 2026-07-15 | Swarm | [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md) |
| MeloTTS (en-v3) | TTS | 3060 / 4090 | **1.4× / 1.4×** | self-comparison (still host/GPU-flat; no perf pass yet) | — | 2026-07-12 | Swarm | [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md) |
| F5-TTS (v1 base) | TTS (clone) | 3060 | **~0.4×** | self before→after (174.6s → 6.4s host-conv fix); Python ref RTF 0.729 (wall÷audio, not cross-compared — different harness/GPU) | 34× (self) | 2026-07-13 | Swarm | [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md), `tests/python-reference/CAMPAIGN_SCORECARD.md` |
| Qwen3-TTS (1.7B) | TTS | 3060 / 4090 | **2.01× / 3.77×** (1.87s/3.76s; 1.14s/4.32s) | official `qwen_tts` (PyTorch): 0.42× (3060) / 0.43× (4090) | **4.8× / 8.8×** faster than official | 2026-07-18 | engine-only | [`qwen3_tts_perf_2026-07-18.md`](../results/qwen3_tts_perf_2026-07-18.md) |
| VibeVoice-1.5B | TTS | 3060 | **1.28×** (6.47s/8.27s) | self before→after (RTF 0.061× → 1.28×, 20.8× cumulative) | 20.8× (self) | 2026-07-17 | standalone harness | [`vibevoice_tts_2026-07-17.md`](../results/vibevoice_tts_2026-07-17.md) |
| CosyVoice 2 (0.5B) | TTS (clone) | 4090 | **0.75×** (7.97s/6.0s) | self before→after (RTF 0.217× → 0.75×, 3.4× cumulative; gallery gen 28.9s→5.1s = 5.7×) | 5.7× (self) | 2026-07-17 | standalone harness | [`cosyvoice2_tts_2026-07-17.md`](../results/cosyvoice2_tts_2026-07-17.md) |
| Chatterbox | TTS (clone) | 3060 | **1.45×** short / **1.11×** long (3.51s/5.08s; 12.36s/13.80s) | self-comparison (inherited CosyVoice2 S3Gen fix for free; "no perf pass needed") | — | 2026-07-18 | standalone harness | [`chatterbox_tts_2026-07-18.md`](../results/chatterbox_tts_2026-07-18.md) |
| Bark (Suno) | TTS | 3060 | **0.44×** (12.23s/5.32s) | self before→after (RTF 0.064× → 0.44×, 6.75× cumulative) | 6.75× (self) | 2026-07-18 | standalone harness | [`bark_tts_2026-07-18.md`](../results/bark_tts_2026-07-18.md) |
| Kyutai TTS (DSM, tts-1.6b) | TTS | 3060 / 4090 | **1.09× / 1.47×** | `moshi` (Python, bf16+CUDA graph): 2.25× (3060) | **0.48×** of moshi (moshi still ~2.1× faster) | 2026-07-18 | engine-only | [`kyutai_tts_perf_2026-07-18.md`](../results/kyutai_tts_perf_2026-07-18.md) (supersedes [`kyutai_tts_2026-07-16.md`](../results/kyutai_tts_2026-07-16.md)'s 0.51×) |
| NeuTTS Air | TTS (clone) | 3060 | **0.52×** decode (7.52s/3.92s); encode (one-time/ref) **0.67×** | self-comparison, verification only (no perf pass run) | — | 2026-07-18 | standalone harness | [`neutts_tts_2026-07-18.md`](../results/neutts_tts_2026-07-18.md) |
| Fish-Speech 1.5 | TTS | 3060 | **~0.95×** (near real-time; 3.56s/3.44s, 6.86s/6.55s) | self-comparison, verification only (no perf pass needed) | — | 2026-07-18 | standalone harness | [`fishspeech_tts_2026-07-18.md`](../results/fishspeech_tts_2026-07-18.md) |
...
| Moonshine | STT | 3060 / 4090 | **6.5× / 6.5×** | self-comparison (word-perfect on real speech) | — | 2026-07-12/13 | Swarm | [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md) |
| Whisper (base) | STT | 3060 / 4090 | **~10× / 5.4×** — 3060 number is fresher (07-18) than the 4090 one (07-12); not re-measured together, flagged not directly conflicting but not confirmed either | self-comparison | — | 2026-07-18 (3060) / 2026-07-12 (4090) | Swarm | [`stt_profiling_2026-07-18.md`](../results/stt_profiling_2026-07-18.md), [`audio_tts_stt_2026-07-12.md`](../results/audio_tts_stt_2026-07-12.md) |
...
| Distil-Whisper | STT | 3060 / 4090 | **3.28× / 2.79×** | self-comparison | — | 2026-07-18 | Swarm | [`stt_profiling_2026-07-18.md`](../results/stt_profiling_2026-07-18.md) (supersedes the 2.27×-equivalent same-day number in [`stt_gaps_2026-07-18.md`](../results/stt_gaps_2026-07-18.md)) |
| Kyutai STT (1B) | STT | 3060 / 4090 | **6.6× / 10.1×** | self before→after (1.24×/1.37× → 6.6×/10.1×) | 5.3×/7.4× (self) | 2026-07-18 | engine-only | [`kyutai_stt_perf_2026-07-18.md`](../results/kyutai_stt_perf_2026-07-18.md) |
...
| Zonos-v0.1 (transformer) | RTX 4090 | host-glue decode (baseline) | 203 | 1.0× | 2026-07-17 | [`zonos_tts_2026-07-17.md`](../results/zonos_tts_2026-07-17.md), [`docs/PERFORMANCE.md`](../../docs/PERFORMANCE.md) |
