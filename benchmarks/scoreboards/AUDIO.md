...
|---|---|---|---:|---|---:|---|---|---|
| MiniMax Music 3 (Q8) | Music | 4090 | **0.57×** (26.4s gen for 15.0s audio) | diffusers PR #14456 bf16, same card/prompt/steps: 49.4s | **1.87× faster** | 2026-08-14 | CLI | 36.7s → 31.3s (depth KV cache) → 28.3s (CFG batching, bit-exact) → 26.4s (depth Q8). Stages: AR 16.6s vs 34.9s, flow+vocode 9.8s vs 14.6s. Baseline repeatability ±0.1s |
