...
preprocessors** (UniFormer / OneFormer ADE20K-COCO) are also deferred — both are large transformer stacks
(≫ the other annotators) with marginal ControlNet usage; revisit if seg conditioning is requested.
