...
#### Testing
- [x] [`Ideogram4PromptTests.cs`](../../tests/HartsyInference.Diffusion.Tests/Ideogram4PromptTests.cs) + [`Ideogram4SchedulerTests.cs`](../../tests/HartsyInference.Diffusion.Tests/Ideogram4SchedulerTests.cs) — **16 pure-logic tests pass** (byte-exact golden Ideogram JSON, validator rejections, NL flatten, bbox→pixels; scheduler monotonicity/bounds/presets).
