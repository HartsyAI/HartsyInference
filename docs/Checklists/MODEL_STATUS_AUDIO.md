...
> | Status | TTS |
> |---|---|
> | ✅ **verified word-correct** | Kokoro, Piper, MeloTTS, F5-TTS, **Bark**, **Chatterbox**, **VibeVoice**, **FishSpeech**, **Orpheus**, **Dia** (Swarm 10/10, all 3 turns, EOS-stops 11.4s — fixed by switching to the `Dia-1.6B-0626` checkpoint), **Kyutai TTS** (DSM, in-engine e2e word-correct 2026-07-16; not yet Swarm-deployed) |
