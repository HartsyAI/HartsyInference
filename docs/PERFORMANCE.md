...
**Current scoreboard** — RTX 4090, warm median, engine `1.0.0-alpha.45`, 2026-07-08. ComfyUI
...
|---|---:|---:|---|
| Z-Image-Turbo | **2.95 s** | 3.1 s | Faster than ComfyUI |
| Krea2-Turbo | **4.50 s** | 6.5 s | Faster than ComfyUI |
