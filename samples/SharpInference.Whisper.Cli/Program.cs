...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        using IBackend backend = new SharpInference.Cpu.CpuBackend();
    ...
    {
        Console.Error.WriteLine("""
            Usage: sharpinference-whisper [options] <wav-file>
            ...
            Models are downloaded to ~/.cache/sharpinference/models/ on first use.
            Audio is auto-resampled to 16 kHz and downmixed to mono.

            Example:
              sharpinference-whisper sample.wav
              sharpinference-whisper -m openai/whisper-large-v3-turbo -l ja --translate clip.wav
            """);
    }
}
